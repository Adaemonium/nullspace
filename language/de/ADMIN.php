...
$LNG['ad_infos_bc_math_active'] = "BCMath Aktiv";
$LNG['ad_infos_curl_active'] = "cURL Aktiv";
$LNG['ad_infos_safe_mode'] = "Abgesicherter Modus";
$LNG['ad_infos_memory_limit'] = "Speicherlimit";
$LNG['ad_infos_mysql_cli_version'] = "MySQL-Client-Version";
$LNG['ad_infos_mysql_server_version'] = "MySQL Server-Version";
$LNG['ad_infos_error_log'] = "Fehlerprotokoll";
$LNG['ad_infos_timezone'] = "Zeitzone (PHP/CONF/USER)";
$LNG['ad_infos_db_suhosin'] = "Suhosin";
$LNG['ad_infos_db_version'] = "DB-Version";
$LNG['ad_infos_game'] = "Spiel";
$LNG['ad_infos_game_version'] = "Spielversion";
$LNG['ad_infos_game_address'] = "Spieladresse";
$LNG['ad_infos_game_pfad'] = "Spiel PFAD";
$LNG['ad_infos_browser'] = "Browser";
$LNG['ad_infos_yes'] = "Ja";
$LNG['ad_infos_no'] = "Nein";
$LNG['ad_infos_active'] = "Aktiv";
$LNG['ad_infos_inactive'] = "Inaktiv";
...
$LNG['settings_successful'] = "Einstellungen erfolgreich geändert!";
$LNG['adm_login_recaptcha_false'] = "Recaptcha falsch!";
...
$LNG['info_information'] = 'Informations-Vorlage zum Posten eines Bugs im <a href="%s" target="tracker">ultimateXnova Board</a><br>Ohne diese Vorlage gibt es keinen Support!';
...
$LNG['ow_title'] = 'Willkommen zu ultimateXnova';
$LNG['ow_donate'] = 'Spende';
$LNG['ow_welcome_text'] = 'Herzlich Willkommen zum allseits beliebten ultimateXnova. (:';
$LNG['ow_overview'] = 'Kontrollzentrum';
$LNG['ow_support'] = 'Support';
$LNG['ow_credits'] = 'Credits';
$LNG['ow_forum'] = 'Forum';
$LNG['ow_proyect_leader'] = 'Projektleitung';
$LNG['ow_translator'] = 'Übersetzer';
...
$LNG['se_ftp_info'] = 'ultimateXnova hat ein eigendes interens Updatesystem. Die Dateien werden intern per FTP hochgeladen. Dafür benötigt ultimateXnova die Server-Daten.<br>Solltest du das System nicht nutzten, kannst du diese Felder frei lasssen.';
...
$LNG['up_need_curl'] = 'Fehler: cURL nicht vorhanden.<br />Das UpdateSystem von ultimateXnova benötigt cURL, um die aktuellen Dateien herunter zu laden.';
$LNG['up_no_xml_ext'] = 'Fehler: XML Parser nicht vorhanden.<br />Das UpdateSystem von ultimateXnova benötigt XML Parser, um die aktuellen Dateien verarbeiten zu können.';

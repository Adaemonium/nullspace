...
$LNG['sys_notenough_money'] 				= 'You dont have enough resources on %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> to build %s. <br>Your resources are: %s %s , %s %s and %s %s. <br>The cost of construction is %s %s , %s %s and %s %s.';
...
$LNG['al_manage_alliance']					= 'Alliance Management';
...
//OPTIONS
$LNG['op_error']							= 'Error';
$LNG['op_cant_activate_vacation_mode']		= 'You cannot activate vacation mode with fleet active.';
...
$LNG['op_activate_vacation_mode_descrip']	= 'Vacation mode protects your account for as long as you are out of the game. But you can only activate it if you have nothing in construction (buildings, fleet, or defense), and there is no debris to be harvested. Once activated, you are protected against attacks. Attacks already sent will continue during the vacation, production will remain at 0% until vacation mode is over, at which time it will be set to 100%. Vacation mode will remain in effect for a minimum time of 48 hours. Only then it can be disabled.';
...
$LNG['fa_not_spy_yourself']					= 'Fault, cannot spy on yourself!';
$LNG['fa_not_attack_yourself']				= 'Fault, cannot attack yourself';

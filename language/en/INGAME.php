...
$LNG['rl_error_type_1'] = "You did not enter the coordinates correctly";
$LNG['rl_error_type_2'] ="Relocation should be started from the planet";
...
$LNG['rl_error_type_10'] = "You cannot move the planet if the planet is under attack !";
...
$LNG['ov_principal_planet_cant_abanone']	= 'You cannot delete the main planet!';
...
$LNG['ov_ac_error_3'] = "Planet name was not entered !";

//----------------------------------------------------------------------------//
// Galaxy

$LNG['gl_no_deuterium_to_view_galaxy']		= 'You do not have enough deuterium to view the galaxy';
...
$LNG['gl_alliance_page']					= 'Alliance Homepage';
$LNG['gl_see_on_stats']						= 'Stats';
$LNG['gl_alliance_web_page']				= 'Alliance Website';
...
$LNG['gl_free_desc'] 						= 'This planet is habitable, and is an ideal place to develop a new colony';
$LNG['gl_free'] 							= 'Free';
$LNG['gl_yes'] 								= 'Yes';
$LNG['gl_no'] 								= 'No';
...
$LNG['fl_ammount']							= 'Quantity';
$LNG['fl_beginning']						= 'Deployed from';
$LNG['fl_departure']						= 'Arrival (Target)';
$LNG['fl_destiny']							= 'Target';
$LNG['fl_objective']						= 'Duration';
...
$LNG['fl_flying_time']					    = 'Time to Destination';
...
$LNG['fl_expedition_alert_message']		    = 'Attention! Explorations are dangerous missions, you may lose your fleet!';
...
$LNG['fl_week_player']						= 'The player is under new player protection.';
$LNG['fl_strong_player']					= 'The player is too strong.';
$LNG['fl_in_vacation_player']				= 'The player is in vacation mode';
$LNG['fl_no_slots']							= 'No slots avaliable';
$LNG['fl_planet_populed']					= 'This planet is populated!';
$LNG['fl_no_same_alliance']				    = 'The target player of the planet must be of your Alliance or be on your friend list!';
...
$LNG['fl_no_empty_derbis']					= 'No debris present!';
...
$LNG['fl_no_expedition_slot']				= "You cannot deploy more expeditions!";
$LNG['fl_invalid_mission']					= 'Invalid mission';
$LNG['fl_bash_protection']					= 'This would violate the Bash Rule';
$LNG['fl_admin_attack']						= "You cannot attack an administrator";
...
$LNG['fl_own_planet_error']					= 'Error! Select the planet from which you want to send the fleet again.';
...
$LNG['bd_lab_required']					    = 'First you must build a research lab!';
$LNG['bd_building_lab']					    = 'You cannot research during lab upgrades.';
$LNG['bd_max_lvl']                          = 'Max. Level:';
$LNG['bd_lvl']								= 'Level';
$LNG['bd_research']							= 'Research for';
$LNG['bd_shipyard_required']				= 'You must build a Shipyard first';
...
$LNG['bd_cancel_warning']                   = 'ATTENTION! <br> Cancelling will only recoup 60% of your costs.';
...
$LNG['sys_notenough_money'] 				= 'You do not have enough resources on %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> to build %s. <br>Your resources are: %s %s , %s %s and %s %s. <br>The cost of construction is %s %s , %s %s and %s %s.';
$LNG['sys_nomore_level'] 					= "There is no building ( %s ) to demolish.";
$LNG['sys_buildlist'] 						= "List of construction";
$LNG['sys_techlist'] 						= 'Research list';
$LNG['sys_buildlist_fail'] 				    = "Building is not possible";
...
$LNG['tr_not_enought']						= "You do not have enough %s.";
$LNG['tr_exchange_done']					= 'Trade successful';
$LNG['tr_exchange_error']					= 'The amount of resources is incorrect or insufficient';
...
$LNG['in_jump_gate_error_data']			    = 'Error, jump coordinates are not correct!';
$LNG['in_jump_gate_not_ready_target']		= 'The portal is not ready on the destination Moon, will be ready in ';
...
$LNG['mg_receiver_block_pm']				= 'The receiver blocks private messages.';
$LNG['mg_deleted']					= 'The message has been deleted.';

//----------------------------------------------------------------------------//
// Aliança

$LNG['al_not_exists']					= 'The Alliance has ceased to exist';
$LNG['al_newname_specialchar']				= 'The alliance and the tag must be written with alphanumeric characters, word, _, -, .!';
$LNG['al_description_message']		        = 'Message from description of Alliance';
$LNG['al_web_text']							= 'Alliance Website';
$LNG['al_request']					        = 'Request Application';
...
$LNG['al_request_confirmation_message']     = 'Registered your request. You will receive a message when youre accepted or/rejected. <br><a href="game.php?page=alliance">back</a>';
$LNG['al_default_request_text']		        = 'The leader of the Alliance did not submit any message of introduction.';
$LNG['al_write_request']					= 'Submit a request to the Alliance %s';
...
$LNG['al_request_wait_message']             = 'You have sent a request to the Alliance %s. <br> Please wait for a reply or delete the request.';
$LNG['al_delete_request']					= 'Delete the request';
...
$LNG['al_circular_sended']					= 'Circular message sent. These players will receive your message:';
...
$LNG['al_has_declined']						= '</b> The Alliance has rejected your request application <br>Message: <br>';
$LNG['al_no_requests']						= 'No requests';
$LNG['al_request_from']						= 'Request for "%s"';
$LNG['al_no_request_pending']				= 'You have %n requests pending';
...
$LNG['al_goto_chat']						= 'Alliance Chat Channel';
$LNG['al_save']								= 'Save';
$LNG['al_dlte']								= 'Delete';
...
$LNG['al_request_date']						= 'Date of request';
...
$LNG['al_your_request_title']				= 'Your request';
$LNG['al_applyform_send']					= 'Send';
$LNG['al_applyform_reload']					= 'Reload';
$LNG['al_apply_not_exists']					= 'The request does not exist.';
...
$LNG['al_diplo_level'][4]                   = 'Non-aggression Pact';
...
$LNG['al_diplo_accept_yes_confirm']		    = 'Do you really accept the Pact?';
$LNG['al_diplo_accept_no']                  = 'Pact Rejected.';
$LNG['al_diplo_accept_no_mes']				= 'The Pact (%s) between the %s and %s was Rejected!';
$LNG['al_diplo_accept_no_confirm']			= 'Do you really reject the Pact?';
...
$LNG['al_diplo_war_mes']                    = 'The Alliance %s and the Alliance %s just the %s declarated.<br>Reason:<br>%s<br><br>Information: the war is valid for 24 hours. Only after the 24 hours, war and given as terminated. <br>For more information consult the <a href="index.php?page=rules" target="_blank">Rules</a>.';
$LNG['al_diplo_head']						= 'Manage Diplomacy';
$LNG['al_diplo_same_alliance']				= 'You cannot make a pact with your own Alliance!';
...
$LNG['al_leave_ally']						= 'Are you sure you want to leave the Alliance?';
$LNG['al_default_leader_name']				= 'Leader';
$LNG['al_rank_name']						= 'Name';
$LNG['al_rank_desc']['MEMBERLIST']			= 'Can see alliance members';
$LNG['al_rank_desc']['ONLINESTATE']			= 'Can see who is online';
$LNG['al_rank_desc']['TRANSFER']			= 'Can be transferred leadership';
$LNG['al_rank_desc']['SEEAPPLY']			= 'Can view applications';
$LNG['al_rank_desc']['MANAGEAPPLY']			= 'Can control applications';
$LNG['al_rank_desc']['ROUNDMAIL']			= 'Can send global messages';
$LNG['al_rank_desc']['ADMIN']				= 'Can edit the Alliance';
$LNG['al_rank_desc']['KICK']				= 'Can kick members';
$LNG['al_rank_desc']['DIPLOMATIC']			= 'Can manage Diplomacy';
$LNG['al_rank_desc']['RANKS']				= 'Can configure Ranks';
...
$LNG['al_new_apply']                      	= 'Your alliance has received a new request application from - <a href="#" onclick="return Dialog.Playercard(%s, \'%s\');">%s</a>';

//----------------------------------------------------------------------------//
// Lista de Amigos
$LNG['bu_request_exists']					= 'There is already an application for this player!';
$LNG['bu_cannot_request_yourself']			= 'You cannot send a friend request to yourself';
...
$LNG['bu_no_request']                       = 'No applications available!';
...
//OPTIONS
$LNG['op_error']							= 'Error';
$LNG['op_cant_activate_vacation_mode']		= 'You cannot activate vacation mode with active fleet.';
...
$LNG['op_email_adress_descrip']				= 'You can change this e-mail address at any time. It will become the permanent e-mail after 7 days, without changes.';
...
$LNG['op_spy_probes_number_descrip']		= 'Number of probes you can send directly from galaxy view.';
$LNG['op_activate_vacation_mode_descrip']	= 'Vacation mode protects your account for as long as you are out of the game. But you can only activate it if you have nothing in construction (buildings, fleet, or defense), and there is no debris to be harvested. Once activated, you are protected against attacks. Attacks already sent will continue during vacation mode. Production will remain at 0% until vacation mode is over, at which time it will be set to 100%. Vacation mode will remain in effect for a minimum time of 48 hours. Only then it can be disabled.';
$LNG['op_dlte_account_descrip']			    = 'If you choose this option your account will be deleted after 7 days.';
$LNG['op_need_pass_mail']                   = 'To change your email address you need to enter the password in the box!';
$LNG['op_not_vaild_mail']					= 'You did not insert a valid E-Mail!';
$LNG['op_change_mail_exist']				= 'The Email inserted %s is already in use!';
$LNG['op_sort_normal']                      = 'By Colonization';
$LNG['op_sort_koords']                      = 'By Coordinates';
$LNG['op_sort_abc']                         = 'By Alphabet';
$LNG['op_sort_up']                          = 'Ascendant';
$LNG['op_sort_down']                        = 'Descendant';
$LNG['op_user_name_no_alphanumeric']        = 'Please enter your user name in alphanumeric characters only!';
$LNG['op_change_name_pro_week']             = 'You can change your username once only every 7 days!';
$LNG['op_change_name_exist']                = 'The name chosen %s already exists';
$LNG['op_active_build_messages']            = 'Enable building notifications';
...
$LNG['cff_mission_acs']						= 'A %s from %s %s %s reaches the %s %s %s. Mission: %s';
$LNG['cff_mission_own_0']					= 'One of your %s from %s %s %s reaches the %s %s %s. Mission: %s';
...
$LNG['cff_mission_own_expo_0']				= 'One of your %s from %s %s %s reaches the Position %s. Mission: %s';
...
$LNG['cff_mission_own_recy_0']				= 'One of your %s from %s %s %s reaches the debris %s. Mission: %s';
$LNG['cff_mission_own_recy_1']				= 'One of your %s returns from debris %s back to planet %s %s %s. Mission: %s';
$LNG['cff_mission_target_bad']				= 'A hostile %s from player %s from %s %s %s reaches the %s %s %s. Mission: %s';
$LNG['cff_mission_target_good']				= 'A friendly %s from player %s from %s %s %s reaches the %s %s %s. Mission: %s';
...
$LNG['cr_lost_contact']                     = 'Lost contact with your fleet.';
...
$LNG['fa_not_spy_yourself']					= 'Fault, you cannot spy on yourself!';
$LNG['fa_not_attack_yourself']				= 'Fault, you cannot attack yourself!';
$LNG['fa_action_not_allowed']				= 'Fault, action not allowed';
$LNG['fa_vacation_mode_current']			= 'Fault, you are in vacation mode';
$LNG['fa_sending']							= 'Send';
...
$LNG['ma_not_send_other_galaxy']			= 'You cannot send missiles into another galaxy. ';
$LNG['ma_planet_doesnt_exists']				= 'Planet does not exist. ';
$LNG['ma_wrong_target']						= 'Wrong Target';
$LNG['ma_no_missiles']						= 'No Missles';
$LNG['ma_add_missile_number']				= 'Add missile quantity! ';
$LNG['ma_misil_launcher']					= 'Rocket Launcher';
$LNG['ma_small_laser']						= 'Light Laser Cannon';
$LNG['ma_big_laser']						= 'Heavy Laser Cannon';
...
$LNG['tkb_unentschieden']					= '<b>-Draw- </b>';
...
$LNG['ti_create_info']						= '<p>When creating a support Ticket, describe and explain your issue with the maximum detail possible!</p>
<p>A detailed description of what you want to ask, shortens the duration of time of resolution and avoids wasting time on both sides</p>
<p>For issues related to accounts, specifics will shorten the time to resolve the problem.</p>';

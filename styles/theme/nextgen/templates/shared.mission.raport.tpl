...
<table style="width:auto;" class="table table-gow table-sm fs-12">
	<tr>
		<td>
			{$LNG.fleet_attack_1} {$RoundInfo.info[0]|number}<br>{$LNG.fleet_attack_2} {$RoundInfo.info[3]|number} {$LNG.damage}<br>
			{$LNG.fleet_defs_1} {$RoundInfo.info[2]|number}<br>{$LNG.fleet_defs_2} {$RoundInfo.info[1]|number} {$LNG.damage}
		</td>
	</tr>
</table>
<br>
...
$LNG.
			...
			{/if}
			<br><br>
			{$LNG.sys_attacker_lostunits} {$Raport['units'][0]|number} {$LNG.sys_units}
			<br>

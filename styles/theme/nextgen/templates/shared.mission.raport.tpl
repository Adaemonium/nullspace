...
<table style="width:auto;" class="table table-gow table-sm fs-12">
	<tr>
		<td>
			{$LNG.fleet_attack_1} {$RoundInfo.info[0]|number} {$LNG.fleet_attack_2}<br>{$RoundInfo.info[3]|number} {$LNG.damage}<br>
			{$LNG.fleet_defs_1} {$RoundInfo.info[2]|number} {$LNG.fleet_defs_2}<br>{$RoundInfo.info[1]|number} {$LNG.damage}
		</td>
	</tr>
</table>
<br>

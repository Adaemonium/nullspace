...
<div class="dark-blur-bg menu-container box-shadow-large">
    ...
    <div class="uk-grid" uk-grid>
      <div class="uk-width-1-1 uk-width-1-5@m uk-text-center"><a href="game.php?page=overview"><img class="logo" src="styles/resource/images/nullspace.svg" style="max-width:220px;height:auto;"/></a></div>

...
<div class="wrapper">
	...
	<logo>
		<div class="fixed">
			<a href="game.php?page=overview"><img src="styles/resource/images/nullspace.svg" width="400px"/></a>
		</div>
	</logo>
	...
	<footer>
	    ...
	    {if isModuleAvailable($smarty.const.MODULE_BATTLEHALL)}
			...
			<a class="font-size-12 px-2 border-end" href="{$discordUrl}" target="copy">Stoat</a>
			{/if}

...
<div id="leftmenu">
	<div class="adm-logo"><img src="./styles/resource/images/nullspace.svg" style="max-width:200px;height:auto;"></div>
    ...
    {if allowedTo('ShowChatPage')}
      <li class="d-flex {if $currentPage == 'chat' && $mode == 'log'}menu-active{/if}">
        <a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6" href="?page=chat&mode=log" >{$LNG.mu_chat_log}</a>
      </li>
    {/if}
